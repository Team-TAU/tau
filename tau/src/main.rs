...
pub struct RouterState {
    ...
    pub oauth_cache: Arc<Mutex<HashMap<CsrfToken, UserTokenBuilder>>>,
    pub kv: Arc<Mutex<kv_store::KVStore>>,
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let state = RouterState {
        pool,
        oauth_cache: Arc::new(HashMap::new().into()),
...
mod auth {
    ...
    async fn login_auth(
        ...
        let mut cache = state.oauth_cache.lock().await;
